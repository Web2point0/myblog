...
function generateIframe(username) {
  ...
  let src = `https://myyear.net/hiscore/Test13/osrs/your-template.html?user=${encodeURIComponent(username)}&color=${encodeURIComponent(currentTextColor)}&font=${encodeURIComponent(currentFontFamily)}`;
