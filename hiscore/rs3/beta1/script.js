...
function generateIframe(username) {
  ...
  let src = `https://myyear.net/hiscore/rs3/beta1/your-template.html?user=${encodeURIComponent(username)}&color=${encodeURIComponent(currentTextColor)}&font=${encodeURIComponent(currentFontFamily)}`;
