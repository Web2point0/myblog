...
function generateIframe(username) {
  ...
  let src = `https://myyear.net/hiscore/rs3/beta2/your-template.html?user=${encodeURIComponent(username)}&color=${encodeURIComponent(currentTextColor)}&font=${encodeURIComponent(currentFontFamily)}`;
