...
function generateIframe(username) {
  ...
  let src = `https://myyear.net/hiscore/osrs/alpha/squid/your-template.html?user=${encodeURIComponent(username)}&color=${encodeURIComponent(currentTextColor)}&font=${encodeURIComponent(currentFontFamily)}`;
