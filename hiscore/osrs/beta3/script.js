...
function generateIframe(username) {
  ...
  let src = `https://myyear.net/hiscore/osrs/beta3/your-template.html?user=${encodeURIComponent(username)}&color=${encodeURIComponent(currentTextColor)}&font=${encodeURIComponent(currentFontFamily)}`;
