...
function generateIframe(username) {
  ...
  let src = `https://myyear.net/hiscore/osrs/beta1/your-template.html?user=${encodeURIComponent(username)}&color=${encodeURIComponent(currentTextColor)}&font=${encodeURIComponent(currentFontFamily)}`;
