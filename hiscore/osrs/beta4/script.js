...
function updateEmbedCode() {
  ...
  const iframeCode = `<iframe src="https://myyear.net/hiscore/osrs/beta4/your-template.html?username=${encodeURIComponent(username)}&game=${game}&color=${encodeURIComponent(color)}&font=${encodeURIComponent(font)}&mode=${mode}${bgParam}" width="335" height="249" style="border-radius:8px; border:none; overflow:hidden;" scrolling="no"></iframe>`;
