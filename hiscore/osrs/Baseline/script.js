...
function generateIframe(username, game) {
  ...
  let src = `https://myyear.net/hiscore/osrs/Baseline/your-template.html?user=${encodeURIComponent(username)}&color=${encodeURIComponent(currentTextColor)}&game=${encodeURIComponent(game)}&font=${encodeURIComponent(currentFont)}&mode=${encodeURIComponent(currentMode)}`;
